...
// 1. Необходимо создать html-страницу с названием 1.html, в которой подключить файл 1.js (его тоже необходимо создать 
...
const Num = +prompt("Введите температуру в градусах Цельсия");
     const Num1 = Math.round((Num*1.8 + 32)*100);
     const far = Num1/100
alert(`Температура по Фаренгейту: ${far}\n Температура по Цельсию: ${Num}`);
